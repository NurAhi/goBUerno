              ...
              <li key={index}>
                ...
                <div>
                  ...
                  <p style={{ lineHeight: "24px" }}>
                    Es increíble que ya estemos en ese día tan esperado, temido
                    y soñado...
                  </p>
                  <p>
                  ...
                  <p>
                    Desde luego se puede decir que todo en la vida nos aporta
                    algo y tú, ante esa adversidad allá por el 2015 supiste
                    crecer como nadie, es para sentirse orgullosa.
                  </p>
                  <p>
                    Lo que hoy pase ahí dentro es solo un pasito más. Obviamente
                    importante y nos imaginamos lo nerviosa que puedes estar
                    pero confía en ti, en la buena cabeza que siempre has tenido
                    y esto no es una excepción.
                  </p>
                  <p>
                    Te queremos mucho muchas personas a las que cuidas cada día
                    y de las que estás pendiente, pese a la distancia, a tu poca
                    disponibilidad horaria para hablar, pero siempre encuentras
                    hueco.
                  </p>
                  <p>
                    Hoy será el comienzo de algo distinto, otra etapa y seguro
                    que la disfrutas como haces con todo.
                  </p>
                  <p>¡¡¡SUERTE!!!</p>
                </div>
              </li>
